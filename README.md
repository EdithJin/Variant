...
- [NVDA](examples/NVDA.txt) — AI infrastructure, 21% implied CAGR, macro-adjusted analysis with VIX/geopolitical decomposition
- [TSLA](examples/TSLA.txt) — Autonomy/energy narrative, 80% implied CAGR, severe expectations gap
- [PLTR](examples/PLTR.txt) — Government AI software, 80% implied CAGR, bull case already priced in
- [AAPL](examples/AAPL.txt) — Services/AI integration, 17% implied CAGR, modest overvaluation
